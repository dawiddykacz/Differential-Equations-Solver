...
class Fourth2EquationLoss(Fourth2Equation):
...
class LossSimple(Loss):
    def _condition(self, function, *x):
        ...
        return loss + abs(function(one_x / 2, one_y / 2) + zero) + abs(
            function(one_x / 4, one_y / 4) - one_x / 2) + abs(function(one_x / 4, 3 * one_y / 4) + one_x / 2) + abs(
